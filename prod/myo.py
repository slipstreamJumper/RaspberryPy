...
if __name__ == '__main__':
  ...
  def move_arm():
    upper.ChangeDutyCycle(normalize_gyro_duty_cycle(0- m.gyro_z)//10)  # turn towards 90 degree
    lower.ChangeDutyCycle(normalize_gyro_duty_cycle(0- m.gyro_x)//10)  # turn towards 90 degree
    '''
    if pose == "REST":
